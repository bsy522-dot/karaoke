const CACHE_NAME = 'starvoice-v10';
const ASSETS = ['./', './index.html', './noraebang-v6.html', './v7_patch.js', './v8_patch.js', './v9_patch.js', './v10_patch.js', './manifest.json', './icons/icon-192.png', './icons/icon-512.png'];
