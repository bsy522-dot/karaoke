const CACHE_NAME = 'starvoice-v16';
const ASSETS = ['./', './index.html', './noraebang-v6.html', './v7_patch.js', './v8_patch.js', './v9_patch.js', './v10_patch.js', './v11_patch.js', './v12_patch.js', './v13_patch.js', './v14_patch.js', './v15_patch.js', './v16_patch.js', './manifest.json', './icons/icon-192.png', './icons/icon-512.png'];
